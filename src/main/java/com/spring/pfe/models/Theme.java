...
public class Theme implements Serializable {
    ...
    @Column(name = "progressByTheme")
    private  Boolean progressByTheme;
    ...
    public Boolean getProgressByTheme() {
        return progressByTheme;
    }

    public void setProgressByTheme(Boolean progressByTheme) {
        this.progressByTheme = progressByTheme;
    }
}
